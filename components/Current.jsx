      ...
      <div className="space-y-4 text-sm md:text-[15px] text-gray-400 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><span className="text-[#562e66] mr-2">+</span><strong className="text-white">Studio:</strong> Premium detailing</li>
              <li><span className="text-[#562e66] mr-2">+</span><strong className="text-white">Shield:</strong> Protection services</li>
            </ul>
          </div>
        </div>
