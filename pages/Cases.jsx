...
export default function CaseStudiesPage() {
  return (
    <section className="bg-[#050505] border-t border-white/[0.03] min-h-screen selection:bg-[#562e66] selection:text-white font-sans">

      {/* Top Cover Image */}
    {/* Top Cover Image */}
<div className="w-full border-b border-white/[0.06] bg-black flex justify-center">
  <img
  ...
  />
      ...
      <div className="max-w-7xl mx-auto px-6 py-24 md:py-44">
        ...
        <header className="mb-32 md:mb-52 space-y-8">
          ...
          <h1 className="text-[clamp(3.5rem,10vw,8.5rem)] font-medium tracking-[-0.06em] text-[#f4f4f5] leading-[0.8]">
            Case Studies
            <span className="text-[#562e66] tracking-normal font-light">.</span>
          </h1>
        </header>
            ...
            >
              <div className="flex flex-col lg:grid lg:grid-cols-12 gap-10 md:gap-16 items-start">
                ...
                <div className="lg:col-span-7 flex gap-6 md:gap-14">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-5 text-[10px] font-mono uppercase tracking-[0.2em] text-zinc-500">
                      <span className="group-hover:text-[#8b4ca5] transition-colors duration-500 font-semibold">
                        {study.category}
                      </span>
                ...
                <div className="lg:col-span-5 flex flex-col justify-between h-full pt-2">
                  <p className="text-zinc-500 text-sm md:text-base lg:text-lg leading-relaxed font-light tracking-wide transition-colors duration-700 group-hover:text-zinc-300">
                    {study.description}
                  </p>
